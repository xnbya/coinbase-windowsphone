/*
 * taken from https://developer.nokia.com/Community/Wiki/Generating_and_scanning_barcodes_on_Windows_Phone
 * 	©  Nokia 2013
 */
    ...
    public partial class Scan : PhoneApplicationPage
    {
        ...
        void _bcReader_ResultFound(Result obj)
        {
            // If a new barcode is found, vibrate the device and display the barcode details in the UI
                ...
                Microsoft.Phone.Shell.PhoneApplicationService.Current.State["qrscan"] = obj.Text;
                Dispatcher.BeginInvoke(() =>
                    {
